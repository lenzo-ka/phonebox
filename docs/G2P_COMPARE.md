...
> **Baseline snapshot (2026-05-21):** frozen copy in [`G2P_COMPARE_BASELINE.md`](G2P_COMPARE_BASELINE.md).
> **No config joins:** [`G2P_COMPARE_NO_JOINS.md`](G2P_COMPARE_NO_JOINS.md).
> **Eval guide:** [`G2P_EVAL.md`](G2P_EVAL.md).
> it_IT / pt_BR lexicon experiments: [`experiments/README.md`](experiments/README.md).
